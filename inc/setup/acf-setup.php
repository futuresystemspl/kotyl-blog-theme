 ...
 *	https://www.advancedcustomfields.com/resources/how-to-include-acf-in-a-plugin-or-theme/
 */
...
//	4. Hide the ACF admin menu item and the ACF Updates menu.
add_filter('acf/settings/show_admin', 'theme_acf_settings_show_admin');
add_filter('acf/settings/show_updates', 'theme_acf_settings_show_updates', 100);

function theme_acf_settings_show_admin($show_admin)
{
    return (defined('WP_LOCALHOST') && WP_LOCALHOST == true) ? true : false;
}
function theme_acf_settings_show_updates($show_admin)
{
    return (defined('WP_LOCALHOST') && WP_LOCALHOST == true) ? true : false;
}
